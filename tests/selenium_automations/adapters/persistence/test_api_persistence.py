from automacao_certificados.selenium_automations.adapters.persistence import api_persistence
from automacao_certificados.selenium_automations.adapters.persistence.api_persistence import ApiPersistence
from automacao_certificados.selenium_automations.adapters.persistence.exceptions import DocumentTypeNotFoundError
from automacao_certificados.selenium_automations.core.interfaces import BaseAPIRequester
from automacao_certificados.selenium_automations.core.interfaces.document_persistance import (
    DocumentPersist,
...
class TestGetOrCreateSupplier:
    def test_if_returns_existing_supplier_when_supplier_exists(
        ...
        api_persistence = ApiPersistence(api_requester=api_mock)
...
class TestSave:
    def test_sucess_case_with_already_created_supplier(
        ...
        api_persistence_result = api_persistence.save(document_persist)

        assert isinstance(api_persistence_result, DocumentPersistResult)
