...
from automacao_certificados.selenium_package_extension.actions import SelectOptionByText


class TestSelectOptionByText:
    """
    Test class for the SelectOptionByText action.
    """
    def test_if_raises_value_error_if_desired_option_text_is_not_a_string(
        self,
    ):
        """
